...
public class MyPermissionsActivity extends Activity {
    ...
    private static final String EXTRA_PERMISSIONS = "com.sygj.android.beauty.extra_permission"; // 权限参数
...
//            XUtilLog.log_i("wbb","RuntimePermissions :grantResults[" + grantResults[i] + "] = %s");
        }
