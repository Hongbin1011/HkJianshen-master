...
//        得到所有自定义属性的数组
        ...
        ringColor = typedArray.getColor(R.styleable.RoundProgress_ringColor, Color.TRANSPARENT);
        ...
        textColor = typedArray.getColor(R.styleable.RoundProgress_textColor,Color.WHITE);
        max = typedArray.getInteger(R.styleable.RoundProgress_max,100);
        progress = typedArray.getInteger(R.styleable.RoundProgress_progress,100);
//        不要忘记回收
        typedArray.recycle();
    }
...
//       1、 绘制圆环
        ...
        canvas.drawCircle(circleX, circleY, radius-ringWidth/2, paint);
